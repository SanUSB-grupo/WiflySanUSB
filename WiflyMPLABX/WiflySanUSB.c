...
#pragma udata
char rede[] = "LAESE";       // Set your WiFi SSID name
char senha[] = "l43s32014";    // Set your WiFi password -  if it does not, sometimes it is REQUIRED to remove the password of the router, ie, to configure
                              // empty password and put also the variable as char senha[] = ""; due to different encryption standard on routers
char ip[] = "10.50.11.195";  // Set intranet static IP (DHCP OFF). In this the case the static IP .195 is based on the gateway IP 192.168.1.1.
