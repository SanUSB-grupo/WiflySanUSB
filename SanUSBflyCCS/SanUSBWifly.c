...
char rede[] = "SanUSB";      // Set your WiFi SSID name 
char senha[] = "silveir3";      // Set your WiFi password -  if it does not, sometimes it is REQUIRED to remove the password of the router, ie, to configure
